...
MONO opens Part 1 of the *“Snowdrop” World Tour* at Electric Ballroom on 20 February 2027. The artist's official calendar confirms the London venue and date, and the venue page names FORM Presents as presenter.

## The Snowdrop tour

The programme advertises MONO with special guests, whose names are still to be announced. Set times, set length, running order and finish time have not been published.

The event is advertised for 18:00, but the venue page does not say whether that is doors or another event start time. Confirm the timing before travelling.
